...
class TestBasicMethods(unittest.TestCase):
    ...
    def test_getHolidays(self):
        ...
        self.assertEqual(self.raijin.getHolidays(), {'2017': [[6], [], [20], [13, 14], [1, 2, 15], [], [], [15], [], [12], [1, 9], [6, 8, 25]]})
        self.assertEqual(self.raijin.getHolidays(None, True), {'2017': ['06-01-2017', '20-03-2017', '13-04-2017', '14-04-2017', '01-05-2017', '02-05-2017', '15-05-2017', '15-08-2017', '12-10-2017', '01-11-2017', '09-11-2017']})
